...
<div class="loginpge-cnt regpge-cnt">
  ...
  <div class="login-box-body">
    ...
    <div class="login-logo">
		...
		<?php 
            ...
            echo form_open(base_url().'msme/account/create-account/', $attr);
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" name="mobile" value="<?php echo set_value('mobile'); ?>" placeholder="Mobile Number" class="form-control phone_n_" >
      ...
      <div class="form-group has-feedback">
        ...
        <?php
			...
			$userCategoryRegOptions 		= 	array(	 
			
					''						=> 	'Which of these categories do you fit in?'
					,'Student'				=> 	'Student'
					,'Recent graduate'		=> 	'Recent graduate'
					,'Corp member'			=>	'Corp member'
					,'Employed'				=>	'Employed'
					,'Unemployed'			=>	'Unemployed'
					,'Self Employed'		=>	'Self Employed'
			 );
							
			echo form_dropdown('userCategoryReg', $userCategoryRegOptions, set_value('userCategoryReg'), 'class="form-control"');
      ...
      <div class="form-group has-feedback">
        ...
        <?php
			...
			$userRegRefMediumOptions 		= 	array(	 
			
					''						=> 	'How did you hear about 1Community? '
					,'WhatsApp'				=> 	'WhatsApp'
					,'Facebook'				=> 	'Facebook'
					,'Instagram'			=>	'Instagram'
					,'LinkedIn'				=>	'LinkedIn'
			...
			echo form_dropdown('userRegRefMedium', $userRegRefMediumOptions, set_value('userRegRefMedium'), 'class="form-control userRegRefMedium"');
		
		?>
      
      </div>
      
      <div class="form-group has-feedback othersReg" style="display:none;">
      
        <input type="text" name="ifOthersExplain" value="" placeholder="If others, Please specify" class="form-control" >
...
<!--        <div class="col-xs-8">
        ...
        <div class="col-xs-12">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat btnLogin">Create Account</button>
      ...
      <div class="row nwact-rw">
        ...
        <div class="col-xs-4">
            ...
            <div class="Sign_Up">
				...
				<a href="<?php echo base_url(); ?>msme/account/login/">Sign In</a>

...
<head>
  ...
  <title><?php echo $title; ?></title>
    ...
    <!-- Favicon -->
   <link href="<?php echo base_url(); ?>asset/images/favicon.png" rel="icon" type="image/x-icon" />
...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<?php 
        ...
        echo form_open('msme/account/resend-account-confirmation/',$attr);
    ...
    ?>
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" name="email" value="<?php echo set_value('email'); ?>" placeholder="Provide your Email Address" class="form-control" >
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat btnLogin">Submit</button>

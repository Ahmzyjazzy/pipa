        ...
        <div class="login-bx survey-login-bx">
            ...
            <div class="login-bx-bdy surveyWelcomeBody">
                ...
                <div class="surveyWelcomeHdr">
                   ...
                   Welcome to PIPA Evaluator Feedback Platform
                ...
                <div class="surveyWelcomeBodyText">
                    ...
                    <p>
                          ...
                          Dear <?php if(!empty($surveyorDetail)){ echo ucfirst($surveyorDetail['name']); }?>,

                          <!-- Dear <?php if(!empty($participantDetail)){ echo ucfirst($participantDetail['first_name']) . ' ' .ucfirst($participantDetail['last_name']); }?>, -->
                          
                    </p>
                    
                    <p>
                    
                        Welcome and thank you for considering to submit your feedback for 
                        ...
                        By taking the time to complete it, your response will be used to help 
                        <strong><?php if(!empty($participantDetail)){ echo ucfirst($participantDetail['first_name']) . ' ' .ucfirst($participantDetail['last_name']); }?></strong> 
                        improves better.                          
                    </p>
                    ...
                    <p>
                        ...
                        Let me assure you that your responses are completely secure and annonymous.<br>
                        <strong><?php if(!empty($companyDetails)){ echo ucfirst($companyDetails['company_name']); }?></strong>.
                          
                        <br><br>If you would like to learn more about how we protect your privacy, please click here.
                  ...
                  <div class="surveyWelcomeBodyBTN">
                    ...
                    <a href="<?php echo base_url(); ?>feedback/feedback-entry/<?php echo $surveyor['survey_participant_id'].'/'.$surveyorDetail['survey_surveyor_id'].'/' .$surveyorDetail['survey_question_id'].'/'; ?>" class="btn btn-primary">

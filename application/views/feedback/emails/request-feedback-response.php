...
<title>Feedback Request Reminder</title>
	...
	<div class="container" style="background-color:#fff; padding-bottom:20px; padding-top:20px;">
        ...
        <div class="col-md-12">
            ...
            <div class="mail-welcome-hdr">
				...
				<strong>Evaluator Feedback Response</strong>
        ...
        <div class="col-md-12">
			...
			<div class="" style="margin-bottom:10px; padding-left:10px; line-height:25px;">
				...
				Dear <?php if(!empty($participantDetail)){ echo ucfirst($participantDetail['first_name']).' '.ucfirst($participantDetail['last_name']); }?>,<br><br>

				This is to notify you that one of your surveyor has submitted a recommendation base on your request. <br><br>

				Kindly click or copy the link below to login and review.<br><br>
				
				<a href="<?php echo base_url() .'participant/login'; ?>">
					<?php echo base_url() .'participant/login'; ?>
				</a> 

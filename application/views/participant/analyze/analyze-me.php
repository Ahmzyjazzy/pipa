                                                        ...
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li class="score-line">
                                                                ...
                                                                <div class="score-bar-wrapper">
                                                                    <div class="score-bar {{getColor @index}}-bar" style="width: {{ toPercentage percent }};"></div>
                                                                </div>
                                                            </li>  
                                                            {{/evaluator_categories}}   
                                                            <li class="score-line">
...
<script src="<?php echo base_url() ?>asset/js/analyze_participant.js"></script>

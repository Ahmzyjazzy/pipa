    ...
    <div class="login-outer">
        ...
        <div class="login-bx">
            ...
            <div class="login-bx-bdy">
                ...
                echo form_open('participant/forgot-password/',$attr);
                    ...
                    <div class="form-group has-feedback form-group-grey">
                        ...
                        <fieldset>
                        	...
                        	<input type="text" name="email" autocomplete="off" value="<?php echo set_value('email'); ?>" placeholder="Your email" class="form-control" >

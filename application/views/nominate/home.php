        ...
        <div class="login-bx survey-login-bx">
            ...
            <div class="login-bx-bdy surveyWelcomeBody">
                ...
                <div class="surveyWelcomeHdr">
                   ...
                   Welcome to PIPA Evaluator Nomination Platform
				...
				<div class="surveyWelcomeBodyText">
                   ...
                   <p>
                       ...
                       Welcome and thank you for considering to complete your evaluator nomination process for this Assessment survey. 
                       By taking the time to complete it, your responses will be used to help <strong><?php if(!empty($companyDetails)){ echo ucfirst($companyDetails['company_name']); }?></strong> nominate appropriate evaluator that will evaluate you.
                ...
                <div class="surveyWelcomeBodyBTN">
                	...
                	<a href="<?php echo base_url(); ?>nominate/evaluator-entry/<?php echo $surveyor['survey_id'].'/'.$surveyor['survey_participant_id'].'/'; ?>" class="btn btn-primary">

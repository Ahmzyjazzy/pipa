        ...
        <div class="col-xs-12 col-md-12">
            ...
            <div class="survey-thanks-cont">
                ...
                <div class="survey-thanks-cont-layer1">
                	<p>
                        Awesome, <strong><?php if(!empty($lineManager)){ echo ucfirst($lineManager['line_manager_name']); }?></strong>
                    </p>

                    <p>
                        Your approval for <strong><?php echo ucfirst($participantDetail['first_name']) . ' ' .ucfirst($participantDetail['last_name']); ?></strong>
                        has been submitted to aid his/her evaluation process
                    </p>

...
<title>Nominate Approval Success</title>
	...
	<div class="container" style="background-color:#fff; padding-bottom:20px; padding-top:20px;">
        ...
        <div class="col-md-12">
            ...
            <div class="mail-welcome-hdr">
				...
				Nominee Approval Submitted </strong>
        ...
        <div class="col-md-12">
			...
			<div class="" style="margin-bottom:10px; padding-left:10px; line-height:25px;">
				...
				Dear <strong> <?php if(!empty($lineManager)){ echo ucfirst($lineManager['line_manager_name']); }?> </strong>,
				<br><br>
				Thank you for approving  <?php if(!empty($participantDetail)){ echo ucfirst($participantDetail['first_name']).' '.ucfirst($participantDetail['last_name']); }?> 
				nominees.	

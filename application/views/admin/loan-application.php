<link rel="stylesheet" href="<?php echo base_url(); ?>asset/adminlte/dist/css/loan.css">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12 ">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Process Application - <?php echo $loanType; ?></h3>
            ...
            <?php 
				...
				echo form_open_multipart(base_url().'admin/loan-application/'.$loanID.'/', $attr); 
			?>
                	...
                	<div class="col-md-12" style="padding-top:20px;">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="first-app2" style="padding-top:10px; overflow:auto;">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="first-app3" style="padding-top:10px; overflow:auto;">
						...
						<fieldset>
                            ...
                            <h2 class="fs-title">Process Loan</h2>
                            
                            <div class="form-group">
                                
                                <label>CRC Credit Score</label>
                                
                                <?php
                                
                                    $data	= array('placeholder'=>'CRC Credit Score', 'name'=>'crcCreditScore', 'value'=>set_value('crcCreditScore', $crcCreditScore), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Current Liability', 'name'=>'crcCurrentLiability', 'value'=>set_value('crcCurrentLiability', $crcCurrentLiability), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Number of Loan', 'name'=>'crcNumberLoans', 'value'=>set_value('crcNumberLoans', $crcNumberLoans), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Outstanding Loan amount', 'name'=>'crcOutstandingLoansAmount', 'value'=>set_value('crcOutstandingLoansAmount', $crcOutstandingLoansAmount), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <label>Cash in Account</label>
                                
                                <?php
                                
                                    $data	= array('placeholder'=>'Cash in Account', 'name'=>'cashInAccount', 'value'=>set_value('cashInAccount', $cashInAccount), 'class'=>'form-control phone_n_');
                            ...
                            <div class="form-group">
                                ...
                                <label>Has the cash in account been verified?</label>
                                
                                <?php
                                    
                                    $cashInAccountStatusoptions  = 	array(	 
                                    ...
                                    echo form_dropdown('cashInAccountStatus', $cashInAccountStatusoptions, set_value('cashInAccountStatus',$cashInAccountStatus), 'class="form-control"');
                             ...
                             <div class="form-group">
                                ...
                                <label>Is this Company Registered?</label>
                                
                                <?php
                                    
                                    $validCacRegoptions  = 	array(	 
                                    ...
                                    echo form_dropdown('validCacReg', $validCacRegoptions, set_value('validCacReg',$validCacReg), 'class="form-control"');
                            ...
                            <div class="form-group">
                                ...
                                <label>Has the Corporate Bank Account been verified?</label>
                                
                                <?php
                                    
                                    $validCorporateAccountoptions  = 	array(	 
                                    ...
                                    echo form_dropdown('validCorporateAccount', $validCorporateAccountoptions, set_value('validCorporateAccount',$validCorporateAccount), 'class="form-control"');
                            ...
                            <div class="form-group">
                                ...
                                <label>Has Tax Payment been verified?</label>
                                
                                <?php
                                    
                                    $taxpaymentOptions  = 	array(	 
                                    ...
                                    echo form_dropdown('validTaxPayment', $taxpaymentOptions, set_value('validTaxPayment',$validTaxPayment), 'class="form-control"');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Annual Revenue/Turnover', 'name'=>'annualRevenue', 'value'=>set_value('annualRevenue', $annualRevenue), 'class'=>'form-control phone_n_');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Monthly Expenses', 'name'=>'monthlyExpenses', 'value'=>set_value('monthlyExpenses', $monthlyExpenses), 'class'=>'form-control phone_n_');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Current Asset', 'name'=>'currentAsset', 'value'=>set_value('currentAsset', $currentAsset), 'class'=>'form-control phone_n_');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Fixed Asset', 'name'=>'fixedAsset', 'value'=>set_value('fixedAsset', $fixedAsset), 'class'=>'form-control phone_n_');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Stock Value', 'name'=>'stockValue', 'value'=>set_value('stockValue', $stockValue), 'class'=>'form-control phone_n_');
...
<!--                            
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Total Asset', 'name'=>'totalAsset', 'value'=>set_value('totalAsset', $totalAsset), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $data	= array('placeholder'=>'Profit Margin', 'name'=>'profitMargin', 'value'=>set_value('profitMargin', $profitMargin), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <label>Debt-Income Ratio</label>
                                
                                <?php
                                
                                    $data	= array('placeholder'=>'Debt-Income Ratio', 'name'=>'debtIncomeRatio', 'value'=>set_value('debtIncomeRatio', $debtIncomeRatio), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <label>Debt Coverage Ratio</label>
                                
                                <?php
                                
                                    $data	= array('placeholder'=>'Debt Coverage Ratio', 'name'=>'debtCoverageRatio', 'value'=>set_value('debtCoverageRatio', $debtCoverageRatio), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');
                            ...
                            <div class="form-group">
                                ...
                                <label>Debt-Asset Ratio</label>
                                
                                <?php
                                
                                    $data	= array('placeholder'=>'Debt-Asset Ratio', 'name'=>'debtAssetRatio', 'value'=>set_value('debtAssetRatio', $debtAssetRatio), 'class'=>'form-control phone_n_', 'readonly'=>'readonly');

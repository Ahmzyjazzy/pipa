                    ...
                    <ul class="nav nav-tabs">
                      ...
                      <li class="nav-tab-right" style="width:15%; float:right;">
                        ...
                        <div class="dashb-trans-btn dashb-trans-btn-colored" style="padding-bottom:8px; padding-top:8px;">
                            ...
                            <a href="<?php echo base_url(); ?>admin/create-grades/" style="width:100%;">
                                    ...
                                    <div class="resp-table-body">
                                        ...
                                        if(!empty($grades))
                                        {
											...
											foreach($grades as $grade)
											{
												...
												$company					=	$CI->in_multiarray($grade['company_id'], $companies, 'company_id');
												...
												echo '<div class="resp-table-row '.$tbl_rowtype.'">
													...
													<div class="table-body-cell">
														...
														<a class="btn btn-info" title="Edit/View Grade Details" href="'.site_url('admin/create-grades').'/'.$grade['grade_id'].'/">

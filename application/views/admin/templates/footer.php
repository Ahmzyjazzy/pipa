...
<audio id="notifisound" src="<?php echo base_url(); ?>asset/audio/notification.wav" preload="auto"></audio>
...
<script src="<?php echo base_url(); ?>asset/admin_asset/js/admin.js"></script>

<!-- ChartJS -->
<script src="<?php echo base_url() ?>asset/adminlte/bower_components/chart.js/Chart.js"></script>

<script type="text/javascript" src="<?php echo base_url(); ?>asset/admin_asset/js/adminproduct.js?v=2.1.5"> </script>

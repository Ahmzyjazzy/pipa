        ...
        <div class="col-xs-12 col-md-12">
            ...
            <div class="survey-thanks-cont">
                ...
                <div class="survey-thanks-cont-layer1">
                    ...
                    <p>
                    	This 360  assessment for <strong><?php if(!empty($participantDetails)){ echo ucfirst($participantDetails['first_name']).' '.ucfirst($participantDetails['last_name']); }?></strong> has already been completed by you.
                    </p>

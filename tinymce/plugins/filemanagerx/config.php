...
$base_url	="http://localhost/labonubi/"; //url base of site if you want only relative url leave empty
...
$upload_dir   = '/labonubi/uploads/wysiwyg/images/'; // path from base_url to upload base dir
$current_path = '../../../../../uploads/wysiwyg/images/'; // relative path from filemanager folder to upload files folder

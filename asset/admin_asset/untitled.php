	...
	<div class="container" style="background-color:#fff; padding-bottom:20px; padding-top:20px;">
        ...
        <div class="col-md-12">
        	...
        	<div class="" style="margin-bottom:10px; padding-left:10px; line-height:25px;">
                ...
                <p>
                    You have been added as an Admin for [Company Name] on the [Platform Name] platform.
                </p>
                
                <p>
                    click on the link below to set your password and gain access to the platform:
                </p>
                ...
                <p>
                    ...
                    If you have any questions, please feel free to contact us at <span class="msg-mail-cnct"><a href="mailto:support@pipa.com">support@pipa.com</a></span>. 

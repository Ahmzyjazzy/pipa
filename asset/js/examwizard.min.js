...
var currentPage=$(settings.quickAccessOption.quickAccessInfoSelector).attr('data-current-page');$(settings.quickAccessOption.quickAccessSection+' [data-question]').hide();$(settings.quickAccessOption.quickAccessSection+' [data-question]:nth-child(-n+'+(group*currentPage)+')').show();if(currentPage>1){$(settings.quickAccessOption.quickAccessSection+' [data-question]:nth-child(-n+'+(group*(currentPage-1))+')').hide(); $('.show-mrked-lnk').show();}

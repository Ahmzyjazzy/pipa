...
$(function () {
    ...
    contactFormObj.on('click', function () {
        ...
        var datax = {
			...
			reason: 	reasonFieldObj.val()
        };
        
		if (datax.firstName === '' || datax.lastName === '' || datax.email === '' || datax.phone === '' || datax.message === '' || datax.reason === '') {
		    ...
		    if (validateEmail(emailaddress)) {
				...
				$.ajax({
                    type: "POST",
                    url: base_url+"pages/contactus-mail",
                    data: datax,
					dataType: 'json',
